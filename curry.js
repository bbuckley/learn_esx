...
const d = d => 1 / (1 + d);
const a = (i = 0.05, n = 10, boy) =>
  (1 - Math.pow(1.0 / (1 + i), n)) / (i / (1.0 + i));
console.log(d(0.08));
console.log(a());

const aa = ({ i = 0.08, n = 10, boy = true, m = 12 }) =>
  (1 - Math.pow(1 / (1.0 + i), n)) / (boy ? i / (1.0 + i) : i);
...
const test = (
  {
    ...
    round = true,
    pv = true,
    meta = { round: 10, show_params: false }
  }
) => {
  console.log();
  console.log("i=" + i);
